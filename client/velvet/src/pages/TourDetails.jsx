...
function TourDetails() {
  ...
  return (
    <section className='relative mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12'>
      <img src="/background/samyrai.png" alt="" aria-hidden="true" className="absolute md:bottom-[600px] bottom-[800px] -right-20 md:h-[600px] h-[400px] opacity-[10] pointer-events-none select-none" />
      <Helmet>
      ...
      <div className='relative mt-8 sm:mt-10'>
        <img src="/background/hram.png" alt="" aria-hidden="true" className="absolute -right-70 -top-6 h-[700px] opacity-[10] pointer-events-none select-none" style={{mixBlendMode:'multiply'}} />
